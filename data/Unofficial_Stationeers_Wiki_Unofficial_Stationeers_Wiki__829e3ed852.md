...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Hydraulic+Pipe+Bender&returntoquery=action%3Dedit%26section%3D3)
...
== Recipes == <!--T:3--> Expand to see the recipes. <div class="mw-collapsible-content">'''Used to create:''' {{:Hydraulic_Pipe_Bender/Recipes}} </div> </div> 
