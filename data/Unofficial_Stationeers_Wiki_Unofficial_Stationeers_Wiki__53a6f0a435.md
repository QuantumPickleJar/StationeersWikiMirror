...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Kit+%28Atmospherics%29+Electrolyzer&returntoquery=action%3Dedit%26section%3D2)
...
## Editing Kit (Atmospherics) Electrolyzer (section)
...
==Characteristics== * It has a manual power switch. * It consumes #W of [[Power]] per [[Tick]] when idle. * It consumes a maximum of #kW of [[Power]] per [[Tick]] when active. * It has a separate [[Power Port]] and [[Data Port]]. * It has a pipe port (labelled "Input") for the water that '''will be''' electrolyzed. * It has a pipe port (labelled "Output") for the produced H<sub>2</sub> + O<sub>2</sub> gas mixtured. * It outputs a perfect [[Special:MyLanguage/Fuel|Fuel]] mixture of 66.6% H<sub>2</sub> + 33.3% O<sub>2</sub>. <!--T:3--> 
