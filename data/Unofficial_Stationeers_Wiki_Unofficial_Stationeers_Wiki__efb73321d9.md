...
__
  ...
  * Toolbox
  * [What links here](/Special:WhatLinksHere/Template:Data_Network_Header "A list of all wiki pages that link here \[j\]")
  * [Related changes](/Special:RecentChangesLinked/Template:Data_Network_Header "Recent changes in pages linked from this page \[k\]")
  * [Upload file](/Special:UploadWizard "Upload files \[u\]")
  * [Special pages](/Special:SpecialPages "A list of all special pages \[q\]")
  * [Page information](/index.php?title=Template:Data_Network_Header&action=info "More information about this page")



  * [Log in](/index.php?title=Special:UserLogin&returnto=Template%3AData+Network+Header&returntoquery=action%3Dedit%26section%3DT-1)
...
_  Actions_
  ...
  * [Template](/Template:Data_Network_Header "View the template \[c\]")
  * [Discussion](/index.php?title=Template_talk:Data_Network_Header&action=edit&redlink=1 "Discussion about the content page \[t\]")
  * [Edit](/index.php?title=Template:Data_Network_Header&action=edit "Edit this page")
  * [History](/index.php?title=Template:Data_Network_Header&action=history "Past revisions of this page \[h\]")



#### Template

## Editing Data Network Header (section)

##### 

**Warning:** You are not logged in. Your IP address will be publicly visible if you make any edits. If you **[log in](https://stationeers-wiki.com/index.php?title=Special:UserLogin&returnto=Template%3AData_Network_Header)** or **[create an account](https://stationeers-wiki.com/index.php?title=Special:CreateAccount&returnto=Template%3AData_Network_Header)** , your edits will be attributed to your username, along with other benefits. 

Anti-spam check. Do **not** fill this in!

== Data Network Properties == These are all [[:Category:Data Network|Data Network]] properties of this device. <includeonly>[[Category:Data Network]]</includeonly><noinclude> {{Documentation}} <!-- Categories go on the /doc subpage, and interwikis go on Wikidata. --> </noinclude> 
...
Retrieved from "<https://stationeers-wiki.com/Template:Data_Network_Header>"
