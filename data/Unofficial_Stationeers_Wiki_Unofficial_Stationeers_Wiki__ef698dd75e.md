...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Hydraulic+Pipe+Bender&returntoquery=action%3Dedit%26section%3D4)
...
== Tips == <!--T:4--> # Create an oxygen filter ASAP, so that you can harvest Oxygen into an empty canister # Create a pollutants filter if you're using an Arc Furnace (or otherwise) indoors, to filter out 'Toxic' atmosphere </translate> 
