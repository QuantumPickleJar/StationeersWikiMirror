...
__
  ...
  * Toolbox
  * [What links here](/Special:WhatLinksHere/Kit_\(Pipe_Valve\) "A list of all wiki pages that link here \[j\]")
  * [Related changes](/Special:RecentChangesLinked/Kit_\(Pipe_Valve\) "Recent changes in pages linked from this page \[k\]")
  * [Upload file](/Special:UploadWizard "Upload files \[u\]")
  * [Special pages](/Special:SpecialPages "A list of all special pages \[q\]")
  * [Page information](/index.php?title=Kit_\(Pipe_Valve\)&action=info "More information about this page")



  * [Log in](/index.php?title=Special:UserLogin&returnto=Kit+%28Pipe+Valve%29&returntoquery=action%3Dedit)
...
_  Actions_
  ...
  * [Page](/Kit_\(Pipe_Valve\) "View the content page \[c\]")
  * [Discussion](/index.php?title=Talk:Kit_\(Pipe_Valve\)&action=edit&redlink=1 "Discussion about the content page \[t\]")
  * [Edit](/index.php?title=Kit_\(Pipe_Valve\)&action=edit "Edit this page")
  * [History](/index.php?title=Kit_\(Pipe_Valve\)&action=history "Past revisions of this page \[h\]")



## Editing Kit (Pipe Valve)

##### 

**Warning:** You are not logged in. Your IP address will be publicly visible if you make any edits. If you **[log in](https://stationeers-wiki.com/index.php?title=Special:UserLogin&returnto=Kit_%28Pipe_Valve%29)** or **[create an account](https://stationeers-wiki.com/index.php?title=Special:CreateAccount&returnto=Kit_%28Pipe_Valve%29)** , your edits will be attributed to your username, along with other benefits. 

Anti-spam check. Do **not** fill this in!

{{Itembox | name = Kit (Pipe Valve) | image = [[File:ItemPipeValve.png]] | paintable = Yes | constructs = [[Pipe Valve]], <br>[[One Way Valve (Gas)]],<br>[[Condensation Valve]],<br>[[Expansion Valve]] | recipe_machine1 = Hydraulic Pipe Bender | recipe_cost1 = 3g [[Iron]],<br>2g [[Copper]] | stacks = Yes | hashid = }}[[Category:Atmospherics]][[Category:Gas]][[Category:Liquid]] = Description = This kit is used to create a valve of various types. This kit produces the following: * [[Pipe Valve]] * [[One Way Valve (Gas)]] * [[Condensation Valve]] * [[Expansion Valve]] = Usage = Use the mouse scroll wheel to navigate the different build options. Use the left mouse button to place the selected build option. = See Also = * [[Pipes]] * [[Hydraulic Pipe Bender]] * [[Atmosphere]] 
...
[Cancel](/Kit_\(Pipe_Valve\)) |  [Editing help](https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Editing_pages) (opens in new window)
...
Retrieved from "<https://stationeers-wiki.com/Kit_(Pipe_Valve)>"
