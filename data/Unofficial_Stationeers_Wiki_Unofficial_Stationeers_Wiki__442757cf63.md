...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Autolathe&returntoquery=action%3Dedit%26section%3D11)
...
== Internal Memory == <div class="mw-customtoggle-internalmemory" style="width:auto; overflow:auto; text-indent:10px; border: 2px solid #253C60; border-radius:10px;"><b>Click here to see/hide all the <span style="color:#E57125;">internal memory</span></b></div> <div class="mw-collapsible mw-collapsed" id="mw-customcollapsible-internalmemory"><br>{{:Autolathe/Internal_Memory}}</div> 
