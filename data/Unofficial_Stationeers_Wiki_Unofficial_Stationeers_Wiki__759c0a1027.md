...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Autolathe&returntoquery=action%3Dedit%26section%3D5)
...
=== Import/Export === The <b>Autolathe</b> supports importing and exporting items. Both of those ports can be interacted by using [[Chutes]]. On the left side is the input which only accepts Ingots. The port on the right side is used for exporting fabricated items - which happens automatically - and the stored ingots. 
