...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Autolathe&returntoquery=action%3Dedit%26section%3D7)
...
== Upgrade == The Autolathe can be upgraded from tier one to tier two by using an [[Mod_Kit#Autolathe_Printer_Mod|Autolathe Printer Mod]]. 
