...
__
  ...
  * [Log in](/index.php?title=Special:UserLogin&returnto=Autolathe&returntoquery=action%3Dedit%26section%3D10)
...
== Data Network Properties == <div class="mw-customtoggle-datanetworkproperties" style="width:auto; overflow:auto; text-indent:10px; border: 2px solid #253C60; border-radius:10px;"><b>Click here to see/hide all the <span style="color:#E57125;">data network properties</span></b></div> <div class="mw-collapsible mw-collapsed" id="mw-customcollapsible-datanetworkproperties"><br>{{:Autolathe/Data_Network}}</div> 
