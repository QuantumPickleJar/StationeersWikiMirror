...
__
  ...
  * Toolbox
  * [What links here](/Special:WhatLinksHere/Constructionkit_\(Pipes\) "A list of all wiki pages that link here \[j\]")
  * [Related changes](/Special:RecentChangesLinked/Constructionkit_\(Pipes\) "Recent changes in pages linked from this page \[k\]")
  * [Upload file](/Special:UploadWizard "Upload files \[u\]")
  * [Special pages](/Special:SpecialPages "A list of all special pages \[q\]")
  * [Page information](/index.php?title=Constructionkit_\(Pipes\)&action=info "More information about this page")



  * [Log in](/index.php?title=Special:UserLogin&returnto=Constructionkit+%28Pipes%29&returntoquery=action%3Dedit)
...
_  Actions_
  ...
  * [Page](/Constructionkit_\(Pipes\) "View the content page \[c\]")
  * [Discussion](/index.php?title=Talk:Constructionkit_\(Pipes\)&action=edit&redlink=1 "Discussion about the content page \[t\]")
  * [Edit](/index.php?title=Constructionkit_\(Pipes\)&action=edit "Edit this page")
  * [History](/index.php?title=Constructionkit_\(Pipes\)&action=history "Past revisions of this page \[h\]")



## Editing Constructionkit (Pipes)

##### 

**Warning:** You are not logged in. Your IP address will be publicly visible if you make any edits. If you **[log in](https://stationeers-wiki.com/index.php?title=Special:UserLogin&returnto=Constructionkit_%28Pipes%29)** or **[create an account](https://stationeers-wiki.com/index.php?title=Special:CreateAccount&returnto=Constructionkit_%28Pipes%29)** , your edits will be attributed to your username, along with other benefits. 
...
[Cancel](/index.php?title=Constructionkit_\(Pipes\)&redirect=no) |  [Editing help](https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Editing_pages) (opens in new window)

Retrieved from "<https://stationeers-wiki.com/Constructionkit_(Pipes)>"
